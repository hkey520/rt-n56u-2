...
#define EVM_RESTART_SCUT		(1ULL << 49)
#define EVM_RESTART_TTYD		(1ULL << 50)
#define EVM_RESTART_VLMCSD		(1ULL << 51)
#define EVM_RESTART_CHINADNS		(1ULL << 52)
#define EVM_RESTART_DNSFORWARDER	(1ULL << 53)
#define EVM_RESTART_SHADOWSOCKS	(1ULL << 54)
#define EVM_RESTART_SS_TUNNEL		(1ULL << 55)
